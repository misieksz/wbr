	...
	$.fn.lightbox = function(options) {
		...
		*/
		function initialize() {
			...
			imageData += '<a href="javascript://" id="bottomNavZamknij" title="' + opts.strings.closeTitle + '"><img src="'+opts.fileBottomNavCloseImage+'"></a></div></div></div>';
		...
		$.fn.lightbox.defaults = {
		  triggerEvent: "click",
			...
			strings: {
				...
				closeTitle: 'zamknij galerię zdjęć',
				image: 'Image ',
				of: ' of ',
				download: 'Download'
			},
